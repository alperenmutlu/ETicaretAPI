...
namespace ETicaretAPI.API.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        [HttpGet("{Id}")]
        public async Task<IActionResult> GetByIdAsync([FromRoute]GetByIdProductQueryRequest getByIdProductQueryRequest)
        {
        ...
        {
            UpdateProductCommandResponse reponse = await _mediator.Send(updateProductCommandRequest);
            return Ok();
        }
